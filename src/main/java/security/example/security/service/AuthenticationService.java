...
public class AuthenticationService {
    ...
    public ResponseEntity<?> authenticate(AuthenticationRequest authenticationRequest){
        try{
            ...
            return ResponseEntity.ok(AuthenticationResponse.builder().access_token(jwtAccessToken).refresh_token(jwtRefershToken).email(user.getEmail()).user_name(user.getUser_name()).build());
